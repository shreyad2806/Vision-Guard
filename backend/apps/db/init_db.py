...
# Columns added for Downstream Analytics
_DOWNSTREAM_COLUMNS = [
    ("downstream_analytics_json", "TEXT NOT NULL DEFAULT '[]'"),
]
...
def _add_missing_columns() -> None:
    ...
    all_columns = _PHASE3_COLUMNS + _PHASE4_COLUMNS + _PHASE6_COLUMNS + _DOWNSTREAM_COLUMNS
